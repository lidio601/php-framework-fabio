...
require_once(dirname(__FILE__).DS.'joomla.1.0.php');
require_once(dirname(__FILE__).DS.'joomla.1.5.php');
require_once(dirname(__FILE__).DS.'registry'.DS.'registry.php');
...
class JDatabase extends JObject
{
	...
	*/
	...
	function getConnectors() {
		require_once(dirname(__FILE__).DS.'filesystem'.DS.'folder.php');
	...
	*/
	...
	{
		require_once(dirname(__FILE__).DS.'recordset.php');
